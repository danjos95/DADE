...
class DFPPAFPN(nn.Module):
    ...
    def online_forward(self, input, buffer=None, node='star'):
        ...
        #####
        #star: start: copy current feature and concat
        if node=='star':
        ...
        #rerrent_pan_out: current feature012, pan_out: DFP module
        elif node=='buffer':
        ...
        #return DFP feature , current feature
